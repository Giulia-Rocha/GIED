...
class ItemServiceTest {
    ...
    void deveLancarExcecaoAoRegistrarSaidaComEstoqueInsuficiente() {
        ...
        assertEquals("Estoque insuficiente. Total disponivel 30.", exception.getMessage());
    }
    ...
    void deveConsultarEstoqueDeItemExistente() {
        ...
        // Ação
        List<LoteEstoque> lotes = itemService.ConsultarEstoque(idItemExistente);
    ...
    void deveLancarExcecaoAoConsultarEstoqueDeItemInexistente() {
        ...
        // Ação e Verificação
        IllegalStateException exception = assertThrows(IllegalStateException.class, () -> {
            itemService.ConsultarEstoque(idItemInexistente);
        });
